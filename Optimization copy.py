...
C_s_vector = rccar2.np.linspace(0, 1, 100)
sum_x = rccar2.np.zeros(len(C_s_vector))
sum_y = rccar2.np.zeros(len(C_s_vector))
sum_v = rccar2.np.zeros(len(C_s_vector))
min_v = 10000
min_x = 10000
min_y = 10000
...
C_s_erro_x_min = C_s_vector[rccar2.np.argmin(abs(sum_x))] # Try to catch the minimal error - varying C_s
C_s_erro_y_min = C_s_vector[rccar2.np.argmin(abs(sum_y))]
C_s_erro_v_min = C_s_vector[rccar2.np.argmin(abs(sum_v))]
